...
@section('content_header')
    ...
    gap: 1px;
">
        <i class="fas fa-store"></i><i class="fas fa-box-open"></i> Data Usaha Produk
    </h1>
@stop

@section('content')
    <a href="{{ route('admin.usaha_produk-create') }}" class="btn btn-success btn-sm">
        <i class="fas fa-add"></i> Tambah Usaha Produk</a>
    {{-- tambahkan jarak dan garis --}}
    <br>
    {{-- tambahkan garis lurus --}}
    <hr color="#ccc">
    {{-- Tabel --}}
    <table id="usaha_produk-table" class="display" style="width:100%">
        <thead>
            <tr>
                <th>Nama Usaha</th>
                <th>Nama Produk</th>
            ...
            @foreach ($usahaProduks as $usahaProduk)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.usaha_produk-destroy', $usahaProduk->id) }}" method="POST"
